...
Namespace Global.MyBooks.Repository.Libraries
    ...
    Public Class LibraryAccessBase
        ...
        Private searchAuthor As String
        ...
        Private serviceURIStr As String

        Public Sub New()
            Current = Me
        End Sub

        Public Sub SetSearchParameters(Optional author As String = "", Optional title As String = "") Implements ILibraryAccess.SetSearchParameters
        ...
        Protected Function GetInitialQueryURI() As Uri
        ...
        Public Sub ExecuteQuery(maxNumberOfHits As Integer) Implements ILibraryAccess.ExecuteQuery
